...
[CreateAssetMenu(menuName = "AI/Actions/Movement/Follow", fileName = "Follow")]
public class AIBasicFollowAction : AIBasicAction
{
    ...
    private void FollowTarget(AIBasicStateController controller){
